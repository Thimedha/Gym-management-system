...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($user_name) || empty($contact_no) || empty($email) || empty($message) || empty($date) || empty($time) || empty($status)) {
            $errorMessage = " All the fields are required";
            break;
        }

        // add new member into database
        $sql = "INSERT INTO appointment_table (user_name, contact_no, email, message, date, time, status)" . "VALUES ('$user_name', '$contact_no', '$email', '$message', '$date', '$time', '$user_id' )";
    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="contact_no" value="<?php echo $ontact_no; ?>">
                </div>
            </div>
            <div class="row mb-3">
