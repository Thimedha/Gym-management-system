...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        if (empty($id) ||  empty($worm_up) || empty($equipment) || empty($physical_ex)  || empty($diet_plan)) {
            $errorMessage = "All the fields are required";
            break;
        }
        $sql = "UPDATE schedule " .
            "SET worm_up = '$worm_up', equipment ='$equipment', physical_ex = '$physical_ex',diet_plan ='$diet_plan'" .
            "WHERE id = $id";
