<main>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						...
						<a class="btn info" href="Schedule_Create.php" role="button"> New Schedule</a>
					</div>
			...
			<table class="table">
				...
				<tbody>
                    ...
                    <td >
                        <a class='btn warning btn-sm' href='Schedule_edit.php?id=$row[id]'>Edit</a>
                        <a class='btn danger btn-sm' href='Schedule_Delete.php?id=$row[id]'>Delete</a>
                    </td>
                </tr>
                    ";
					}
