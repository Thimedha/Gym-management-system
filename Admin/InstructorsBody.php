...
<main>
	...
	<div class="table-data">
		<div class="order">
			...
			<a class="btn info" href="Instructors_Create.php" role="button"> New Instructors</a>
			<br><br>
			...
			<table class="table">
				...
				<tbody>
                    ...
                    <td >
                        <a class='btn warning btn-sm' href='Instructors_Edit.php?id=$row[id]'>Edit</a>
                        <a class='btn danger btn-sm' href='Instructors_Delete.php?id=$row[id]'>Delete</a>
                    </td>
                </tr>
                    ";
					}
