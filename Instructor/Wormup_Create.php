...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO warm_up (name, details)" . "VALUES ('$name', '$details' )";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3 d-grid">
                    <button type="submit" class="btn btn-primary">Worm-Up ADD</button>
                </div>
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="Wormup.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
