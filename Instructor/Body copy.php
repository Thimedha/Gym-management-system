<main>
	...
	<div class="table-data">
		<div class="order">
			...
			<a class="btn info" href="Announsments_Create.php" role="button"> New Announcements</a>
			...
			<table class="table">
				...
				<tbody>
                    ...
                    <td >
                        <a class='btn info btn-sm' href='Announsments__Edit.php?id=$row[id]'>Update</a>
                        <a class='btn danger btn-sm' href='Announsments__Delete.php?id=$row[id]'>Delete</a>
                    </td>
                </tr>
                    ";
					}
