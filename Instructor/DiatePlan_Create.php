...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO diet ( details)" . "VALUES ('$details')";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3 d-grid">
                    <button type="submit" class="btn btn-primary">Diet ADD</button>
                </div>
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="DiatePlan.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
