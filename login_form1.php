...
<form action="" method="post">
   ...
   ?>
   <input type="email" name="email" required placeholder="enter your email" style="width: 350px; height:40px;font-size: 16px;"> 
   <input type="password" name="password" required placeholder="enter your password" style="width: 350px;height:40px;font-size: 16px;">
